...
Fetches relevant jobs based on user description and saves them to applicable.csv
"""
...
class JobFetcher:
    ...
    def apply_filters(self) -> None:
        ...
        try:
            ...
            self.wait.until(EC.presence_of_element_located((By.XPATH, '//button[normalize-space()="All filters"]'))).click()
    ...
    def calculate_date_posted(self, time_posted_text: str) -> str:
        ...
        # This is a simplified version - you might want to implement proper date parsing
    ...
    def save_jobs_to_csv(self, jobs: List[JobInfo], filename: str = "applicable.csv"):
...
def main_fetch():
    ...
    try:
        ...
        # Save to CSV
        fetcher.save_jobs_to_csv(all_jobs)
